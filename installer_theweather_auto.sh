...
FILEPATH="/tmp/TheWeather-master.tar.gz"
...
find_plugin_source()
{
    ...
    if [ -f "$TMPPATH/TheWeather-master/__init__.py" ] &&
       [ -f "$TMPPATH/TheWeather-master/plugin.py" ]; then

        PLUGIN_SOURCE="$TMPPATH/TheWeather-master"
